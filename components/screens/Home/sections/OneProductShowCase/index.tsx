      ...
      {data ? (
        <ProductShowcase
          ...
          textContainer={{
            ...
            button: {
              children: OnLiveSecondSectionChange.button || data.button,
              href: OnLiveSecondSectionChange.buttonUrl || data.buttonUrl,
            },
          }}
          imageContainer={{
            mainImg: {
              ...
              onClick: () =>
                router.push(
                  OnLiveSecondSectionChange.buttonUrl || data.buttonUrl
                ),
