...
import { getUpSellingPopup } from "~/utils/core/API";
import { getProduct, getProducts } from "~/libs/shopify";
import { CartItem, ShopifyProduct } from "~/libs/shopify/types";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const MainHeader = (props: any) => {
  ...
  const bannerId = banner.data && banner.data.bannerUrl.split("/")[1];
