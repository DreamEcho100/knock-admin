  ...
  return (
    ...
    >
      <form className="mx-auto my-4 sm:w-11/12" onSubmit={editBanner.mutate}>
        <fieldset className="mt-2 space-y-4" disabled={editBanner.isPending}>
          <FormField
            values={formValues}
    ...
    >
      <div className="mx-auto my-4 sm:w-11/12">
        <fieldset
          ...
          disabled={editMainSection.isPending}
        >
          <FormField
            values={formValues}
            setValues={setFormValues}
...
const EditHomePageSecondSection = ({
  ...
  return (
    ...
    >
      <div className="mx-auto my-4 sm:w-11/12">
        <fieldset className="mt-2 space-y-4" disabled={editSection.isPending}>
          <FormField
            values={formValues}
            setValues={setFormValues}
            name="h2"
        ...
        <fieldset className="mt-2 space-y-4" disabled={editSection.isPending}>
          ...
          <div className="flex justify-end mt-4">
            <Button
              type="submit"
              classesIntent={{ w: "full" }}
              disabled={resetSection.isPending}
              onClick={resetSection.mutate}
            >
              Reset
            </Button>
  ...
  return (
    ...
    >
      <form className="mx-auto my-4 sm:w-11/12" onSubmit={addReview.mutate}>
        <fieldset className="mt-2 space-y-4" disabled={addReview.isPending}>
          <FormField
            values={formValues}
            setValues={setFormValues}
            name="review"
  ...
  return (
    ...
    >
      <form className="mx-auto my-4 sm:w-11/12" onSubmit={addArtist.mutate}>
        <fieldset className="mt-2 space-y-4" disabled={addArtist.isPending}>
          <FormField
            values={formValues}
            setValues={setFormValues}
            name="name"
  ...
  return (
    ...
    >
      ...
      >
        <fieldset
          className="mt-2 space-y-4"
          disabled={addBulletPoint.isPending}
        >
          <FormField
            values={formValues}
            setValues={setFormValues}
...
const AddProduct = ({ isOpen, setIsOpen, setOpenImage }) => {
  ...
  return (
    ...
    >
      <div className="mx-auto my-4 sm:w-11/12">
        <fieldset className="mt-2 space-y-4" disabled={addProduct.isPending}>
          <FormField
            values={formValues}
            setValues={setFormValues}
            name="handle"
